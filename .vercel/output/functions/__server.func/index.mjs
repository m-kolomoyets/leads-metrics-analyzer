import { d as defineLazyEventHandler, a as H3Core, H as HTTPError } from './_libs/h3.mjs';
...
const _lazy_2DbS3U = defineLazyEventHandler(() => import('./_chunks/ssr-renderer.mjs'));
const findRoute = /* @__PURE__ */ (() => {
    const data = { route: '/**', handler: _lazy_2DbS3U };
    return (_m, p) => {
