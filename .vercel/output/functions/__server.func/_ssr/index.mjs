...
var HTTPError = class HTTPError2 extends Error {
    ...
    constructor(arg1, arg2) {
        ...
        const status = sanitizeStatusCode(
            details?.status || details?.statusCode || details?.cause?.status || details?.cause?.statusCode,
            500
        );
...
var tt = {
    ...
    nt = { 0: v, 1: pr, 2: R, 3: C, 4: dr, 5: gr, 6: yr, 7: Nr, 8: br, 9: vr, 10: Cr, 11: P$1, 12: Ar },
...
var Ce = {
    ...
    st = { 0: Error, 1: EvalError, 2: RangeError, 3: ReferenceError, 4: SyntaxError, 5: TypeError, 6: URIError };
...
typeof globalThis != 'undefined'
    ? Object.defineProperty(globalThis, L, { value: U, configurable: true, writable: false, enumerable: false })
    : typeof window != 'undefined'
      ? Object.defineProperty(window, L, { value: U, configurable: true, writable: false, enumerable: false })
      : typeof self != 'undefined'
        ? Object.defineProperty(self, L, { value: U, configurable: true, writable: false, enumerable: false })
...
async function Ln(e, r, t, n2) {
    ...
    if (i & 1 && typeof AggregateError != 'undefined' && (a === AggregateError || n2 instanceof AggregateError))
        return _n(e, r, t, n2);
...
function Bt(e, r, t) {
    Zn(r)
        ? (e[r] = t)
        : Object.defineProperty(e, r, { value: t, configurable: true, enumerable: true, writable: true });
}
...
function ir(e, r) {
    return Gt
        ? (e.length === 1 ? e[0] : '(' + e.join(',') + ')') + '=>' + (r.startsWith('{') ? '(' + r + ')' : r)
...
function Ba(e, r, t, n2, a) {
    ...
    if (s & 1 && typeof AggregateError != 'undefined' && (a === AggregateError || n2 instanceof AggregateError))
        return xa(e, r, t, n2);
...
function Sn(e, r) {
    let t = A(r.plugins),
        n2 = Jr({
            ...
            onParse(a, s) {
                let i = lr({ plugins: t, features: n2.base.features, scopeId: r.scopeId, markedRefs: n2.base.marked }),
                    u;
                try {
                    u = fr(i, a);
                } catch (l) {
...
async function getStartManifest(matchedRoutes) {
    const { tsrStartManifest } = await import('../_tanstack-start-manifest_v-NAGK31of.mjs');
...
const manifest = {
    '11a07940daad52d178b28c761c31f13e0abf489057b0545f01b18e88f37e23e8': {
        functionName: 'deleteUserFn_createServerFn_handler',
        importer: () => import('./functions-CyXOx2-N.mjs'),
    },
    '234f4cead3236d9dbf1e5435c147da848cc8d58286433eb3fe7f127f9f6cee98': {
        functionName: 'createUserFn_createServerFn_handler',
        importer: () => import('./functions-CyXOx2-N.mjs'),
    },
    '45893ca7f6a1a2b0ddd1eab61ee06e5568c27b0977a5c12f1b0e803535312e74': {
        functionName: 'listTeamsFn_createServerFn_handler',
        importer: () => import('./functions-CyXOx2-N.mjs'),
    },
    '541821caf8acb648a6880b1dd1a4064ae0cde067de0c012d4e72e79439c9d1a3': {
        functionName: 'logoutFn_createServerFn_handler',
        importer: () => import('./functions-B4vAkPMi.mjs'),
    },
    '5dae9ea880ac4b6fc903edbb803c9a8f7204127c6bbeded7b8286402673f232d': {
        functionName: 'resendInvitationFn_createServerFn_handler',
        importer: () => import('./functions-CyXOx2-N.mjs'),
    },
    '61e62bee5fe070e3d3451243793279e26aa2ea6e59850d90ff70cb33d287d148': {
        functionName: 'meFn_createServerFn_handler',
        importer: () => import('./functions-B4vAkPMi.mjs'),
    },
    '6d69451eee36ff58fb791cbb4eec0f15e3ea56b6b1cf8d46d959d43547a6fbb3': {
        functionName: 'listUsersFn_createServerFn_handler',
        importer: () => import('./functions-CyXOx2-N.mjs'),
    },
    ba37af0122d3475dd1b7289425ea54d9ddeecd11372fa2e7f24fbd03f12ddca0: {
        functionName: 'setTeamLeadFn_createServerFn_handler',
        importer: () => import('./functions-CyXOx2-N.mjs'),
    },
    c4e96b41d3c28bedef7426fc9a09126d4197153b4285d64558a96b563da0c38a: {
        functionName: 'deleteTeamFn_createServerFn_handler',
        importer: () => import('./functions-CyXOx2-N.mjs'),
    },
    c9fe8570b6ba7c14cef30cfedd5a8ed7e79b6654992f280c6569c005a92691e1: {
        functionName: 'updateTeamFn_createServerFn_handler',
        importer: () => import('./functions-CyXOx2-N.mjs'),
    },
    de679316d5ed59ce667549d45bf242b425b91745d24de4534c58ef303c01d680: {
        functionName: 'activateFn_createServerFn_handler',
        importer: () => import('./functions-B4vAkPMi.mjs'),
    },
    ebfc11faca05eae0aa69ac0fed4d252bd151c9caf5e3b97f56c115ee04adcf98: {
        functionName: 'loginFn_createServerFn_handler',
        importer: () => import('./functions-B4vAkPMi.mjs'),
    },
    eed2d0a904899c29f8b6f308600676242b268d9827ca9d37fd051a72a96ab871: {
        functionName: 'updateUserFn_createServerFn_handler',
        importer: () => import('./functions-CyXOx2-N.mjs'),
    },
    f1629487f63b203d7703bbab0987d78ec5a5fd55b5f1da4a061f8891d9dff976: {
        functionName: 'createTeamFn_createServerFn_handler',
        importer: () => import('./functions-CyXOx2-N.mjs'),
    },
};
...
function flattenMiddlewares(middlewares, maxDepth = 100) {
    ...
    const recurse = (middleware, depth) => {
        if (depth > maxDepth)
            throw new Error(`Middleware nesting depth exceeded maximum of ${maxDepth}. Check for circular references.`);
...
async function loadEntries() {
    const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
        import('./router-BqEFGHsP.mjs').then((n2) => n2.p),
...
function createStartHandler(cbOrOptions) {
    ...
    const startRequestResolver = async (request, requestOpts) => {
        ...
        try {
            ...
            const { hasPluginAdapters: hasPluginAdapters2, pluginSerializationAdapters: pluginSerializationAdapters2 } =
...
async function handleServerRoutes({ getRouter, request, url, executeRouter, context, executedRequestMiddlewares }) {
    ...
    if (server2?.handlers && isExactMatch) {
        const handlers =
            typeof server2.handlers === 'function' ? server2.handlers({ createHandlers: (d) => d }) : server2.handlers;
