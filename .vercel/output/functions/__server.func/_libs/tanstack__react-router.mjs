...
import { j as jsxRuntimeExports, R as React, r as reactExports } from './react.mjs';
import {
    v as appendUniqueUserTags,
    B as BaseRootRoute,
    b as BaseRoute,
    c as BaseRouteApi,
    q as createNonReactiveMutableStore,
    p as createNonReactiveReadonlyStore,
    y as createSsrStreamResponse,
    d as deepEqual,
    s as escapeHtml,
    e as exactPathTest,
    f as functionalUpdate,
    t as getAssetCrossOrigin,
    u as getScriptPreloadAttrs,
    k as getScrollRestorationScriptForRouter,
    h as hasKeys,
    i as invariant,
    a as isDangerousProtocol,
    g as isModuleNotFoundError,
    j as isNotFound,
    o as isRedirect,
    m as isServer,
    n as notFound,
    ...
    l as rootRouteId,
    R as RouterCore,
    z as transformPipeableStreamWithRouter,
...
function MatchView({ router, matchId, resetKey, matchState }) {
    ...
    const ResolvedSuspenseBoundary =
        ...
        (route.options.wrapInSuspense ?? PendingComponent ?? (route.options.errorComponent?.preload || resolvedNoSsr))
...
function Matches() {
    ...
    const PendingComponent =
        router.routesById[rootRouteId].options.pendingComponent ?? router.options.defaultPendingComponent;
    const pendingElement = PendingComponent ? /* @__PURE__ */ jsxRuntimeExports.jsx(PendingComponent, {}) : null;
