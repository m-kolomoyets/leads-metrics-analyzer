import {
    ...
    p as getAxisLength,
    v as getExpandedPlacements,
    B as getOppositeAxis,
    w as getOppositeAxisPlacements,
...
export { shift as a, computePosition as c, flip as f, hide as h, limitShift as l, offset as o, size as s };
