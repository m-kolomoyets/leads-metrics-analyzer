...
const Toast = (props) => {
    ...
    }, [mounted, toast2.title, toast2.description, setHeights, toast2.id, toast2.jsx, toast2.action, toast2.cancel]);
    ...
    return /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement(
            ...
            /* @__PURE__ */ React.createElement(
                ...
                toast2.jsx ? toast2.jsx : typeof toast2.title === 'function' ? toast2.title() : toast2.title
            ),
            toast2.description
                ? /* @__PURE__ */ React.createElement(
                      'div',
...
const Toaster = /* @__PURE__ */ React.forwardRef(function Toaster2(props, ref) {
    ...
    const possiblePositions = React.useMemo(() => {
        return Array.from(
            new Set(
                [position].concat(filteredToasts.filter((toast2) => toast2.position).map((toast2) => toast2.position))
            )
        );
