...
import { g as getDefaultExportFromCjs, a as requireReact } from './react.mjs';
...
function requireReactDomServerLegacy_node_production() {
    ...
    var ReactSharedInternals = React.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,
        ReactDOMSharedInternals = ReactDOM2.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,
    ...
    function writeStyleResourceAttributeInJS(destination, name, value) {
        ...
        switch (name) {
            ...
            default:
                if (
                    (2 < name.length && ('o' === name[0] || 'O' === name[0]) && ('n' === name[1] || 'N' === name[1])) ||
            ...
            if ('string' === typeof href && href) {
                ...
                if (!resumableState.connectResources[bucket].hasOwnProperty(href)) {
                    ...
                    if ((JSCompiler_temp = resumableState && 0 < resumableState.remainingCapacity)) {
                        ...
                        JSCompiler_temp =
                            ((header = JSCompiler_temp), 0 <= (resumableState.remainingCapacity -= header.length + 2));
                    }
                    JSCompiler_temp
        ...
        if ('function' === typeof type)
            if (type.prototype && type.prototype.isReactComponent) {
                ...
                'function' === typeof ref &&
                    ...
                    (initialState = null === ref || void 0 === ref ? initialState : assign({}, initialState, ref)),
                    (newProps.state = initialState));
                if (
    ...
    function trackPostponedBoundary(request, trackedPostpones, boundary) {
        ...
        if (void 0 === boundaryNode)
            return (
                (boundary = [request[1], request[2], children, null, fallbackReplayNode, boundary.rootSegmentID]),
    ...
    function trackPostpone(request, trackedPostpones, task, segment) {
        ...
        if (null === boundary)
            ...
            -1 === segment.id &&
                (segment.id =
                    segment.parentFlushed && null !== boundary ? boundary.rootSegmentID : request.nextSegmentId++);
    ...
    function abortRemainingReplayNodes(request$jscomp$0, boundary, nodes, slots, error, errorDigest$jscomp$0) {
        for (var i = 0; i < nodes.length; i++) {
            var node = nodes[i];
            if (4 === node.length)
                abortRemainingReplayNodes(request$jscomp$0, boundary, node[2], node[3], error, errorDigest$jscomp$0);
            else {
                node = node[5];
                var request = request$jscomp$0,
                    errorDigest = errorDigest$jscomp$0,
                    resumedBoundary = createSuspenseBoundary(request, null, /* @__PURE__ */ new Set(), null, null);
    ...
    function preparePreambleFromSubtree(request, segment, collectedPreambleSegments) {
        ...
        for (var pendingPreambles = false, i = 0; i < segment.children.length; i++)
            pendingPreambles =
                preparePreambleFromSegment(request, segment.children[i], collectedPreambleSegments) || pendingPreambles;
...
function requireReactDomServer_node_production() {
    ...
    function createRenderState(resumableState, nonce, externalRuntimeConfig, importMap, onHeaders, maxHeadersLength) {
        ...
        void 0 !== importMap &&
            ...
            bootstrapScriptContent.push(('' + JSON.stringify(importMap)).replace(scriptRegex, scriptReplacer)),
        ...
        if (void 0 !== bootstrapScripts)
            for (importMap = 0; importMap < bootstrapScripts.length; importMap++)
                ((idPrefix = bootstrapScripts[importMap]),
                    ...
                    bootstrapChunks.push(startScriptSrc, escapeTextForBrowser(maxHeadersLength), attributeEnd),
                    externalRuntimeConfig &&
                        bootstrapChunks.push(scriptNonce, escapeTextForBrowser(externalRuntimeConfig), attributeEnd),
        ...
        if (void 0 !== bootstrapModules)
            for (nonce = 0; nonce < bootstrapModules.length; nonce++)
                ((nonceStyle = bootstrapModules[nonce]),
                    ...
                    bootstrapChunks.push(startModuleSrc, escapeTextForBrowser(bootstrapScripts), attributeEnd),
                    externalRuntimeConfig &&
                        bootstrapChunks.push(scriptNonce, escapeTextForBrowser(externalRuntimeConfig), attributeEnd),
                    'string' === typeof maxHeadersLength &&
                        bootstrapChunks.push(scriptIntegirty, escapeTextForBrowser(maxHeadersLength), attributeEnd),
        ...
        if ('function' === typeof formAction) {
            ...
            null !== customFields
                ? ((name = customFields.name),
                  ...
                  (formTarget = customFields.target),
                  (formData = customFields.data))
                : (target.push(attributeSeparator, 'formAction', attributeAssign, actionJavaScriptURL, attributeEnd),
                  (formTarget = formMethod = formEncType = formAction = name = null),
                  injectFormReplayingRuntime(resumableState, renderState));
        }
        null != name && pushAttribute(target, 'name', name);
    ...
    function isEligibleForOutlining(request, boundary) {
        return (
            (500 < boundary.byteSize || hasSuspenseyContent(boundary.contentState)) && null === boundary.contentPreamble
        );
    }
    function defaultErrorHandler(error) {
        if ('object' === typeof error && null !== error && 'string' === typeof error.environmentName) {
    ...
    function resumeRequest(
        ...
        if ('number' === typeof postponedState.replaySlots)
            return (
                (onError = createPendingSegment(renderState, 0, null, postponedState.rootFormatContext, false, false)),
            ...
            if (!(0 < request.pendingRootTasks)) {
                ...
                for (i = 0; i < clientRenderedBoundaries.length; i++) {
                    ...
                    errorDigest &&
                        ...
                        writeChunk(renderState$jscomp$1, escapeJSStringsForInstructionScripts(errorDigest || '')));
