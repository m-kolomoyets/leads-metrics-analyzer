...
function FieldLabel({ className, htmlFor, ...props }: FieldLabelProps) {
    return (
        <Label
            ...
            className={cn(
                'has-data-checked:border-primary gap-2 group-data-[disabled=true]/field:opacity-50 has-[>[data-slot=field]]:rounded-md has-[>[data-slot=field]]:border *:data-[slot=field]:p-2.5 group/field-label peer/field-label flex w-fit leading-snug',
